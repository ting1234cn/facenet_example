...
def block35(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
    ...
    with tf.variable_scope(scope, 'Block35', [net], reuse=reuse):
        ...
        with tf.variable_scope('Branch_1'):
            ...
            tower_conv1_1 = slim.conv2d(tower_conv1_0, 64, [1,3], scope='Conv2d_0b_1x3')
            tower_conv1_2 = slim.conv2d(tower_conv1_0, 64, [3,1], scope='Conv2d_0c_3x1')
        with tf.variable_scope('Branch_2'):
            tower_conv2_0 = slim.conv2d(net, 32, 1, scope='Conv2d_0a_1x1')
            tower_conv2_1 = slim.conv2d(tower_conv2_0, 96, [3,1], scope='Conv2d_0b_3x1')
            tower_conv2_2 = slim.conv2d(tower_conv2_1, 96, [1,3], scope='Conv2d_0c_1x3')
