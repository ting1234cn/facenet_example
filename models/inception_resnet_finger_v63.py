...
def block35(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
    ...
    with tf.variable_scope(scope, 'Block35', [net], reuse=reuse):
        ...
        with tf.variable_scope('Branch_1'):
            ...
            tower_conv1_1 = slim.conv2d(tower_conv1_0, 32, 5, scope='Conv2d_0b_3x3')
        with tf.variable_scope('Branch_2'):
            tower_conv2_0 = slim.conv2d(net, 32, 1, scope='Conv2d_0a_1x1')
            tower_conv2_1 = slim.conv2d(tower_conv2_0, 32, [5,1], scope='Conv2d_0b_3x3')
            tower_conv2_2 = slim.conv2d(tower_conv2_1, 32, [1,5], scope='Conv2d_0c_3x3')
    ...
    with tf.variable_scope(scope, 'InceptionResnetV1', [inputs], reuse=reuse):
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                # 149 x 149 x 32
                net = slim.conv2d(inputs, 32, 5, stride=2, padding='VALID',
                                  scope='Conv2d_1a_3x3')
