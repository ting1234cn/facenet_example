...
def block35(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
    ...
    with tf.variable_scope(scope, 'Block35', [net], reuse=reuse):
        ...
        with tf.variable_scope('Branch_2'):
            ...
            tower_conv2_1 = slim.conv2d(tower_conv2_0, 32, [3,1], scope='Conv2d_0b_3x3')
            tower_conv2_2 = slim.conv2d(tower_conv2_1, 32, [1,3], scope='Conv2d_0c_3x3')
        with tf.variable_scope('Branch_3'):
            tower_conv3_0 = slim.conv2d(net, 32, 1, scope='Conv2d_0a_1x1')
            tower_conv3_1 = slim.conv2d(tower_conv3_0, 32, [3,1], scope='Conv2d_0b_3x3')
            tower_conv3_2 = slim.conv2d(tower_conv3_1, 32, [1,3], scope='Conv2d_0c_3x3')
        mixed = tf.concat([tower_conv, tower_conv1_1, tower_conv2_2,tower_conv3_2], 3)
        ...
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                with tf.variable_scope('Logits'):
                    ...
                    net = slim.max_pool2d(net, net.get_shape()[1:3], padding='VALID',
